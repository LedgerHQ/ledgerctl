...
- Correcly manage ApiLevel = 0.

## [0.9.1] - 2025-11-26

### Fixed

- Correctly encode empty bip32 paths instead of skipping them.

## [0.9.0] - 2025-11-25

### Added

- Support for `paths_slip21` in the manifest.

## [0.8.1] - 2025-09-09

### Changed

- Align `VersionInfo` with orchestrator for consistency across services.
